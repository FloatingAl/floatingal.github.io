...
export const projectdata = {
  ...
  "Nutrimi": {
    "img": nutrimi,
    "description": "A mobile application that eliminates the need to choose what to eat.",
    "technologies" : ["React Native", "REST API", "React Bootstrap"],
    "url": "https://github.com/FloatingAl/Nutrimi"
  }
