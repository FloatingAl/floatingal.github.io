    ...
    >
        <div className="flex flex-wrap flex-col container items-center aspect-auto justify-between p-6 m-auto font-sans">
          ...
          <div className="flex flex-wrap flex-row container items-center content-center justify-center p-6 max-[340px]:p-2">
            <div className="flex bg-white p-3 border-2 border-gray m-auto 2xl:basis-1/3 xl:basis-2/5 lg:basis-1/2 md:basis-2/3 sm:basis-9/12 max-[640px]:basis-3/4 max-[340px]:basis-full sm:shrink-0 md:shrink-0 lg:shrink-0 max-[640px]:mb-8 shadow-2xl rounded-xl">
              <img src={face} id='face' alt="Albara Mehene profile" className="aspect-square object-cover w-full rounded-xl" />
            </div>
            <div className="mx-auto sm:pt-8 space-y-8 xl:basis-1/2 lg:basis-full md:basis-full sm:basis-full flex flex-col text-justify">
              ...
              <div className="grid grid-flow-col auto-cols-max max-[640px]:space-x-6 space-x-12 pt-6 mx-auto content-center justify-center text-center">
                <div className="flex border-2 bg-white shadow-2xl border-black rounded-full group">
                  <a href="https://github.com/FloatingAl" target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile" className=" flex hover:transition-all duration-300 group-hover:bg-bigorange p-2 rounded-full">
                ...
                <div className="flex border-2 bg-white shadow-2xl border-black rounded-full group">
                  <a href="https://www.linkedin.com/in/albaramehene/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" className="hover:transition-all duration-300 group-hover:bg-bigorange p-2 rounded-full">
                  <svg className=" group-hover:fill-white max-[640px]:w-8 max-[640px]:h-8 w-12 h-12" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 64 64" >
                ...
                <div className="flex border-2 bg-white shadow-2xl border-black rounded-full group">
                <a href={resume} rel="noreferrer" target="_blank" aria-label="Download Resume" className="hover:transition-all duration-300 group-hover:bg-bigorange p-2 rounded-full">
